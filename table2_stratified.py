...
def create_stratified_table2(df):
    ...
    table2_df = pd.DataFrame(rows, columns=columns)
...
if __name__ == "__main__":
    ...
    table2 = create_stratified_table2(eligible_df)
    
    # Save as markdown file
    with open('table2_stratified.md', 'w') as f:
        f.write("# Table 2: Characteristics of Eligible Patients Stratified by CHA₂DS₂-VASc Risk Groups\n\n")
