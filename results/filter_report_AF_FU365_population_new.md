...
**Description**: Population-based AF patients with 1-year stroke prediction outcome to match original dataset analysis. Includes patients with definitive 1-year outcomes: stroke_1Y=1 (stroke within 1Y) vs stroke_1Y=2 (no stroke within 1Y).

**Use Case**: Apples-to-apples comparison with original dataset for 1-year stroke risk prediction

**Notes**: This configuration creates a comparable population to the original dataset by focusing on 1-year stroke prediction. Includes only patients with definitive 1-year outcomes: stroke_1Y=1 (stroke within 1Y) vs stroke_1Y=2 (no stroke within 1Y). Excludes stroke_1Y=3 (stroke after 1Y) and stroke_1Y=4 (pre-AF strokes) for clean comparison.
...
| Stroke outcome in [1, 2] (excluding pre-AF strokes) | 87,220 | 0 | 67.8% |
...
| Stroke outcome in [1, 2] (excluding pre-AF strokes) | 87,220 | 67.8% |
| AF diagnosis before or at time1 + Follow-up period ≥ 365 days | 173,766 | 135.1% |
| AF diagnosis before or at time1 + Stroke outcome in [1, 2] (excluding pre-AF strokes) | 173,766 | 135.1% |
| Follow-up period ≥ 365 days + Stroke outcome in [1, 2] (excluding pre-AF strokes) | 145,842 | 113.4% |
| AF diagnosis before or at time1 + Follow-up period ≥ 365 days + Stroke outcome in [1, 2] (excluding pre-AF strokes) | 348,300 | 270.9% |
